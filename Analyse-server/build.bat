...
call nuitka --standalone --enable-plugin=tk-inter --enable-plugin=no-qt --windows-console-mode=disable --windows-icon-from-ico=bitcoin.ico --output-dir=dist main.py 
...
ren "dist\main.dist\main.exe" "Analyse-Server.exe"
